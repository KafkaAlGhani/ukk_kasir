...
<body>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4">
            <a href="?page=pembelian_tambah" class="btn btn-primary btn-add">+ Tambah Pembelian</a>
        </div>
        ...
        <?php if (isset($sampai_tgl) && isset($sampai_tgl)): ?>
            <a href="pembelian_cetak.php?awal=<?php echo $dari_tgl; ?>&akhir=<?php echo $sampai_tgl; ?>" target="blank" class="btn btn-success mt-3">Cetak</a>
        <?php endif; ?>
